...
export function CosmicBackground({ isMobile, isMobileDualNebula = false, enabled = true, perfTierFloat = 0.0, nebulaPath1 = 1, nebulaPath2 = 3 }) {
    ...
    <>
      {enabled && (
        <DualNebulaBackground 
          ...
          nebulaPath1={nebulaPath1} 
          nebulaPath2={nebulaPath2} 
        />
      )}
      <group ref={starsRef}>
        <EnhancedStarfield
